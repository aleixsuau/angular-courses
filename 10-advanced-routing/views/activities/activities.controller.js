...
ActivitiesController.$inject = ['ActivitiesService', 'CoachesService', '$q', 'activities', 'activitiesCodes', 'coachesCodes', '$rootScope'];

function ActivitiesController (ActivitiesService, CoachesService, $q, activities, activitiesCodes, coachesCodes, $rootScope){
    // Emit event sample
